...
public class HomeFragment extends Fragment {
    ...
    private List<DataItem> listProduk = new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //lmProduk = new LinearLayoutManager(getActivity(), LinearLayoutManager.VERTICAL, false);
    ...
    public void RetrieveData(){
        APIInterface ardProduk = APIClient.getClient().create(APIInterface.class);
        Call<Produk> tampilData = ardProduk.produkResponse();

        tampilData.enqueue(new Callback<Produk>() {
            @Override
            public void onResponse(Call<Produk> call, Response<Produk> response) {
                ...
                adProduk = new AdapterProduk(getActivity(), listProduk);
